game.SpendGold = Object.extend ({
	...
	setBuyText: function(){
		game.data.butText = new (me.Renderable.extend({
			init: function() {
            ...
            draw: function(renderer) {
				...
				this.font.draw(renderer.getContext(), "E Ability: Throw Your Spear: " + game.data.ability3 + " Cost: " +((game.data.ability+1)*10), this.pos.x, this.pos.y) + 240;
			}   
	...
	stopBuying: function () {
		...
		me.input.ubindKey(me.input.KEY.F5, "F5", true);
